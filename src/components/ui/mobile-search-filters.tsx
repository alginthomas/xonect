...
export const MobileSearchFilters: React.FC<MobileSearchFiltersProps> = ({
  ...
  return (
    <div className="sticky top-0 z-40 bg-background border-b border-border/30 p-4 space-y-3">
      ...
      {/* Quick Filters Row - Made Scrollable */}
        ...
        <div className="flex items-center gap-2 pb-1 min-w-max">
          ...
          <Sheet open={isFilterSheetOpen} onOpenChange={setIsFilterSheetOpen}>
            <SheetTrigger asChild>
              <Button variant="outline" size="sm" className="h-8 px-3 text-xs relative flex-shrink-0">
            ...
            <SheetContent side="bottom" className="h-[95vh] max-h-[95vh] flex flex-col p-0">
              ...
              {/* Fixed Action Buttons - Better positioned and responsive */}
          ...
          {totalActiveFilters > 0 && (
            <Button variant="ghost" size="sm" onClick={handleClearAllFilters} className="h-8 px-2 text-xs flex-shrink-0">
      ...
      {totalActiveFilters > 0 && (
        <ScrollArea className="w-full">
          <div className="flex items-center gap-2 flex-wrap min-w-max pb-1">
