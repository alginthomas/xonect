...
import { Users, TrendingUp, Mail, FileText, Database, ArrowUpRight, Calendar, Target } from 'lucide-react';
...
export const AnalyticsDashboard: React.FC<AnalyticsDashboardProps> = ({
  ...
  const recentActivityData = useMemo(() => {
    const last7Days = Array.from({
      ...
      const dayLeads = leads.filter(lead => startOfDay(lead.createdAt).getTime() === date.getTime()).length;
      return {
  ...
  return <div className="space-y-6 px-[16px] py-[16px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="apple-card">
          ...
          <CardContent>
            ...
            <Button variant="link" className="p-0 h-auto text-xs text-muted-foreground hover:text-primary" onClick={() => onNavigateToLeads()}>
        ...
        <Card className="apple-card">
          ...
          <CardContent>
            ...
            <Button variant="link" className="p-0 h-auto text-xs text-muted-foreground hover:text-primary" onClick={() => {/* Navigate to import tab */}}>
            ...
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  ...
                  name,
                  percentage
                }) => `${name} (${percentage}%)`} outerRadius={80} fill="#8884d8" dataKey="value">
            ...
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={recentActivityData}>
                  ...
                  <YAxis />
                  <Tooltip />
                  <Line type="monotone" dataKey="leads" stroke="#3B82F6" strokeWidth={2} dot={{
                  fill: '#3B82F6'
                }} />
                </LineChart>
              </ResponsiveContainer>
      ...
      {/* Import Performance */}
      {importPerformance.length > 0 && <Card className="apple-card">
          <CardHeader>
      ...
      <Card className="apple-card">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Button variant="outline" className="h-20 flex flex-col items-center justify-center gap-2" onClick={() => onNavigateToLeads({
            status: 'New'
          })}>
