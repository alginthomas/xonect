    ...
    try {
      ...
      if (data) {
        const transformedCategory: Category = {
          ...
          criteria: typeof data.criteria === 'object' && data.criteria !== null ? data.criteria as Record<string, any> : {},
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full h-full">
        ...
        <TabsContent value="templates" className={isMobile ? "h-full px-4 pt-4 pb-6" : "space-y-6 lg:space-y-8"}>
          <Card className="apple-card">
            ...
            <CardContent>
              <EmailTemplateBuilder onSaveTemplate={handleSaveTemplate} templates={templates} />
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="settings" className={isMobile ? "h-full px-4 pt-4 pb-6" : "space-y-6 lg:space-y-8"}>
          <Card className="apple-card">
            ...
            <CardContent>
              <BrandingSettings branding={branding} onSave={handleSaveBranding} />
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
