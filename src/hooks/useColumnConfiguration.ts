...
const defaultColumns: ColumnConfig[] = [
  ...
  { id: 'category', label: 'Category', width: 'w-32', sortable: false, visible: true },
  ...
  { id: 'location', label: 'Location', width: 'w-36', sortable: false, visible: false },
  { id: 'industry', label: 'Industry', width: 'w-36', sortable: false, visible: false },
  { id: 'companySize', label: 'Company Size', width: 'w-32', sortable: false, visible: false },
  { id: 'seniority', label: 'Seniority', width: 'w-32', sortable: false, visible: false },
